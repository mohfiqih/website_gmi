            ...
            <div class="container d-flex justify-content-center justify-content-md-between">
                <div class="contact-info d-flex align-items-center">
                    <i class="bi bi-envelope d-flex align-items-center"><a
                            href="mailto:contact@example.com">garudamestakungindonesia@gmail.com</a></i>
                </div>
                <div class="social-links d-none d-md-flex align-items-center">
                    <a href="https://www.youtube.com/@LPKGARUDAMESTAKUNGINDONESIA" class="youtube"><i
                            class="bi bi-youtube"></i></a>
                    <a href="https://www.instagram.com/lpk.gmijapanofficial?igsh=MXVyempkOTIxeWRiMQ%3D%3D"
                        class="instagram"><i class="bi bi-instagram"></i></a>
                    <a href="https://www.tiktok.com/@lpk.gmijapantegal?_t=ZS-8u2sgx8yiAq&_r=1" class="tiktok"><i
                            class="bi bi-tiktok"></i></a>
                    <a href="https://api.whatsapp.com/send/?phone=6282324353371&text&type=phone_number&app_absent=0"
        ...
        <div class="branding d-flex align-items-cente">
            ...
            <div class="container position-relative d-flex align-items-center justify-content-between">
                <a href="index.html" class="logo d-flex align-items-center">
                    <img src="https://garudamestakungindonesia.my.id/img/logo-jepang-removebg.jpg" width="80"
                        height="80" alt="">
                    <span>.</span>
                </a>
            ...
            <div class="container position-relative" data-aos="fade-up" data-aos-delay="100">
                <div class="row gy-5 justify-content-between">
                    <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center">
                        ...
                        <p style="text-align: justify;">Informasi seputar LPK GMI JAPAN, Info Pendaftaran, Persyaratan,
                            Job,
                            Biaya dan Fasilitas. <b>Lokasi:</b> RT.03/RW.03, Kaibun, Balamoa, Kec. Pangkah, Kabupaten
                    ...
                    <div class="col-lg-5 order-1 order-lg-2">
                        <img src="https://garudamestakungindonesia.my.id/storage/images/1744968384_Manual%20Book%20Lpk%20Gmi%20Jepang%20(Tanpa%20WA).jpg"
                            class="img-fluid" alt="">
                    </div>
                </div>
            </div>
                ...
                <div class="row gy-4">
                    <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
                        ...
                        <p style="text-align: justify;">
                            LPK GARUDA MESTAKUNG INDONESIA merupakan suatu lembaga pelatihan kerja Jepang di Wilayah
                            jawa Tengah,
                            khususnya Kabupaten/Kota Tegal yang independen berdasarkan Akte Notaris No. 01 tanggal 18
                            Agustus 2023,
                            yang beralamat di Jl. kaibon Rt. 03 Rw. 03 Desa Balamoa kecamatan Pangkah Kabupaten Tegal.
                            Dengan kewenangan utama melaksanakan pelatihan bahasa yang berbasis kompetensi dalam rangka
                            tujuan untuk membantu mengentaskan kemiskinan dan pengangguran di wilayah Jawa Tengah.
                        </p>
                        <ul>
                    ...
                    <div class="col-lg-6" data-aos="fade-up" data-aos-delay="250">
                        <div class="content ps-0 ps-lg-5">
                            ...
                            <button class="btn btn-success">
                                <a target="_blank"
                                    href="https://api.whatsapp.com/send/?phone=6282324353371&text&type=phone_number&app_absent=0"
                                    class="text-white">
                            ...
                            <div class="position-relative mt-4">
                                <img src="https://garudamestakungindonesia.my.id/storage/images/1732116084_IMG-20241120-WA0049.jpg"
