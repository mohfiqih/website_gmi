...
<head>
  ...
  <!-- Vendor CSS Files -->
  <link href="{{ asset('template_manual_book/assets/vendor/bootstrap/css/bootstrap.min.css') }}" rel="stylesheet">
  <link href="{{ asset('template_manual_book/assets/vendor/bootstrap-icons/bootstrap-icons.css') }}" rel="stylesheet">
  <link href="{{ asset('template_manual_book/assets/vendor/aos/aos.css') }}" rel="stylesheet">
  <link href="{{ asset('template_manual_book/assets/vendor/glightbox/css/glightbox.min.css') }}" rel="stylesheet">
  <link href="{{ asset('template_manual_book/assets/vendor/swiper/swiper-bundle.min.css') }}" rel="stylesheet">

  <!-- Main CSS File -->
  <link href="{{ asset('template_manual_book/assets/css/main.css') }}" rel="stylesheet">
